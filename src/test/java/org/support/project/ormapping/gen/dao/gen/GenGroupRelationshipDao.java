...
public class GenGroupRelationshipDao extends AbstractDao {
	...
	public List<GroupRelationshipEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_physical_select_all.sql");
	...
	public GroupRelationshipEntity physicalSelectOnKey(String childSectionCode, String parentSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_physical_select_on_key.sql");
	...
	public List<GroupRelationshipEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_select_all.sql");
		return executeQueryList(sql, GroupRelationshipEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public GroupRelationshipEntity selectOnKey(String childSectionCode, String parentSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_select_on_key.sql");
		return executeQuerySingle(sql, GroupRelationshipEntity.class, childSectionCode, parentSectionCode);
	}
	/**
	...
	public List<GroupRelationshipEntity> selectOnChildSectionCode(String childSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_select_on_child_section_code.sql");
	...
	public List<GroupRelationshipEntity> selectOnParentSectionCode(String parentSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_select_on_parent_section_code.sql");
	...
	public List<GroupRelationshipEntity> physicalSelectOnChildSectionCode(String childSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_physical_select_on_child_section_code.sql");
		return executeQueryList(sql, GroupRelationshipEntity.class, childSectionCode);
	}
	/**
	 * PARENT_SECTION_CODE でリストを取得
	...
	public List<GroupRelationshipEntity> physicalSelectOnParentSectionCode(String parentSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_physical_select_on_parent_section_code.sql");
		return executeQueryList(sql, GroupRelationshipEntity.class, parentSectionCode);
	}
	/**
	...
	public GroupRelationshipEntity rawPhysicalInsert(GroupRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_raw_insert.sql");
		executeUpdate(sql, 
			entity.getChildSectionCode()
			, entity.getParentSectionCode()
	...
	public GroupRelationshipEntity physicalInsert(GroupRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_insert.sql");
		executeUpdate(sql, 
			entity.getChildSectionCode()
			, entity.getParentSectionCode()
			, entity.getInsertUser()
	...
	public GroupRelationshipEntity physicalUpdate(GroupRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_update.sql");
		executeUpdate(sql, 
			entity.getInsertUser()
			, entity.getInsertDatetime()
			, entity.getUpdateUser()
	...
	public void physicalDelete(String childSectionCode, String parentSectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupRelationshipDao/GroupRelationshipDao_delete.sql");
