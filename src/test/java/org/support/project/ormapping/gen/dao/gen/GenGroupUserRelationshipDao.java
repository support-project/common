...
public class GenGroupUserRelationshipDao extends AbstractDao {
	...
	public List<GroupUserRelationshipEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_physical_select_all.sql");
	...
	public GroupUserRelationshipEntity physicalSelectOnKey(String employeeId, String sectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_physical_select_on_key.sql");
	...
	public List<GroupUserRelationshipEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_select_all.sql");
		return executeQueryList(sql, GroupUserRelationshipEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public GroupUserRelationshipEntity selectOnKey(String employeeId, String sectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_select_on_key.sql");
		return executeQuerySingle(sql, GroupUserRelationshipEntity.class, employeeId, sectionCode);
	}
	/**
	 * EMPLOYEE_ID でリストを取得
	...
	public List<GroupUserRelationshipEntity> selectOnEmployeeId(String employeeId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_select_on_employee_id.sql");
	...
	public List<GroupUserRelationshipEntity> selectOnSectionCode(String sectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_select_on_section_code.sql");
	...
	public List<GroupUserRelationshipEntity> physicalSelectOnEmployeeId(String employeeId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_physical_select_on_employee_id.sql");
		return executeQueryList(sql, GroupUserRelationshipEntity.class, employeeId);
	}
	/**
	 * SECTION_CODE でリストを取得
	...
	public List<GroupUserRelationshipEntity> physicalSelectOnSectionCode(String sectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_physical_select_on_section_code.sql");
		return executeQueryList(sql, GroupUserRelationshipEntity.class, sectionCode);
	}
	/**
	...
	public GroupUserRelationshipEntity rawPhysicalInsert(GroupUserRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_raw_insert.sql");
		executeUpdate(sql, 
	...
	public GroupUserRelationshipEntity physicalInsert(GroupUserRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_insert.sql");
		executeUpdate(sql, 
			entity.getEmployeeId()
			, entity.getSectionCode()
			, entity.getRoleId()
	...
	public GroupUserRelationshipEntity physicalUpdate(GroupUserRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_update.sql");
		executeUpdate(sql, 
			entity.getRoleId()
			, entity.getInsertUser()
			, entity.getInsertDatetime()
	...
	public void physicalDelete(String employeeId, String sectionCode) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/GroupUserRelationshipDao/GroupUserRelationshipDao_delete.sql");
