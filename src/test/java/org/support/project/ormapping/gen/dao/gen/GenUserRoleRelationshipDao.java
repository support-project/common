...
public class GenUserRoleRelationshipDao extends AbstractDao {
	...
	public List<UserRoleRelationshipEntity> physicalSelectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_physical_select_all.sql");
	...
	public UserRoleRelationshipEntity physicalSelectOnKey(String employeeId, String roleId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_physical_select_on_key.sql");
	...
	public List<UserRoleRelationshipEntity> selectAll() { 
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_select_all.sql");
		return executeQueryList(sql, UserRoleRelationshipEntity.class);
	}
	/**
	 * キーで1件取得 
	...
	public UserRoleRelationshipEntity selectOnKey(String employeeId, String roleId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_select_on_key.sql");
		return executeQuerySingle(sql, UserRoleRelationshipEntity.class, employeeId, roleId);
	}
	/**
	 * EMPLOYEE_ID でリストを取得
	...
	public List<UserRoleRelationshipEntity> selectOnEmployeeId(String employeeId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_select_on_employee_id.sql");
	...
	public List<UserRoleRelationshipEntity> selectOnRoleId(String roleId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_select_on_role_id.sql");
	...
	public List<UserRoleRelationshipEntity> physicalSelectOnEmployeeId(String employeeId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_physical_select_on_employee_id.sql");
		return executeQueryList(sql, UserRoleRelationshipEntity.class, employeeId);
	}
	/**
	 * ROLE_ID でリストを取得
	...
	public List<UserRoleRelationshipEntity> physicalSelectOnRoleId(String roleId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_physical_select_on_role_id.sql");
		return executeQueryList(sql, UserRoleRelationshipEntity.class, roleId);
	}
	/**
	...
	public UserRoleRelationshipEntity rawPhysicalInsert(UserRoleRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_raw_insert.sql");
		executeUpdate(sql, 
	...
	public UserRoleRelationshipEntity physicalInsert(UserRoleRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_insert.sql");
		executeUpdate(sql, 
			entity.getEmployeeId()
			, entity.getRoleId()
			, entity.getInsertUser()
	...
	public UserRoleRelationshipEntity physicalUpdate(UserRoleRelationshipEntity entity) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_update.sql");
		executeUpdate(sql, 
			entity.getInsertUser()
			, entity.getInsertDatetime()
			, entity.getUpdateUser()
	...
	public void physicalDelete(String employeeId, String roleId) {
		String sql = SQLManager.getInstance().getSql("/org/support/project/ormapping/gen/dao/sql/UserRoleRelationshipDao/UserRoleRelationshipDao_delete.sql");
