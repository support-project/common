...
public class ConnectionConfig implements Serializable {
	...
	/**
	 * @param autocommit セットする autocommit
	 */
	...
	public String toString() {
		...
		builder.append("ConnectionConfig [name=").append(name)
				.append(", driverClass=").append(driverClass).append(", URL=")
				.append(URL).append(", user=").append(user)
				.append(", password=").append(password).append(", schema=")
				.append(schema).append(", maxConn=").append(maxConn)
